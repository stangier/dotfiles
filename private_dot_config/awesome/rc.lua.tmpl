...
beautiful.init("/home/lorenz/.config/awesome/theme.lua")
...
calendarwidget = wibox.widget.calendar.month(os.date('*t'))
...
globalkeys = gears.table.join(
    ...
    awful.key({"Ctrl", "Shift" }, "l",
    	function()
		awful.spawn("i3lock-fancy")
	end,
	{description = "lock screen", grop="client"}
	),
    awful.key({ modkey,           }, "k",
        function ()
            awful.client.focus.byidx(-1)
